...
Checks whether certificates are valid or not

### Synopsis

Checks whether certificates are valid or not. It automatically searches all secrets in all namespaces, so it does not need any flags to specify where to look
