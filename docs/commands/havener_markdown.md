...
Generates markdown documentation for havener.
...
```
  ...
  -o, --output-dir string   Specifies a directory where markdown documents will be generated. (default "./docs")
```
